...
class CategorySearchResultDesign extends StatefulWidget {
  final Product product;
  CategorySearchResultDesign({
    required this.product
  });

  @override
  State<CategorySearchResultDesign> createState() => _CategorySearchResultDesignState();
}

class _CategorySearchResultDesignState extends State<CategorySearchResultDesign> {
  @override
